...
from app.modules.city_events.services.emergency_payload import (
...
RAW_FILE = APP_DIR / "data" / "city_events" / "emergency_contacts.json"
PUBLIC_FILE = APP_DIR / "data" / "public" / "city_events" / "emergency_contacts.json"
